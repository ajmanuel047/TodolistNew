...
function displayFirstProjectTodo(){
    let currentProjectName = document.querySelector('.projectsBox').children[0].querySelector('.spanProjectName').textContent
    // console.log(currentProjectName)
    let projects = allProjects().getProjects()
...
//     if(e){
//         if(e.target.className == 'submitProject' || e.target.className == 'allProjects' || e.target.className == 'editProjectName' || e.target.className == 'saveChanges'){
//           let currentProjectName = projects[i]['project']['projectName']
...
//           if(projects[i]['project']['project status'] == 'Not Completed' || projects[i]['project']['project status'] == undefined){
//          console.log('uncompleted prrrrr')
//             let currentProjectName = projects[i]['project']['projectName']
//             console.log(currentProjectName)
//             let dateCreated = formatDate().getDate() 
//           if(document.querySelector('.projectContainer .newProjectName')){
...
//         let displayText = document.createElement('p')
//         displayText.classList.add('displayText')
//         projectsBoxItems.classList.add('displayTextDiv')
...
//          displayText.textContent = 'All Projects Completed'
//         }        
//         projectsBoxItems.appendChild(displayText)
//       }else{
//         projectsBoxItems.appendChild(currentProjectStatusText)
//         spanElementProjectName.textContent = currentProjectName
//         currentProjectStatusText.appendChild(spanElementProjectName)
